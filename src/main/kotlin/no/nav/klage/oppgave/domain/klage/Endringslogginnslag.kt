...
enum class Felt {
    ...
    JOURNALPOST_I_VEDTAK, VEDTAK_SLUTTFOERT, REGISTRERINGSHJEMLER, BESTILLINGS_ID, UTSENDING_STARTET, AVSLUTTET_AV_SAKSBEHANDLER,
    ...
    DOKUMENT_UNDER_ARBEID_BREVMOTTAKER_IDENTS, SMARTDOKUMENT_TEMPLATE_ID, SMARTDOKUMENT_VERSION, SMARTDOKUMENT_OPPRETTET,
    SENDT_TIL_TRYGDERETTEN, KJENNELSE_MOTTATT, FRIST, FULLMEKTIG, ANKEBEHANDLING_OPPRETTET_BASERT_PAA_ANKE_I_TRYGDERETTEN, FEILREGISTRERING,
    JOURNALFOERT_DOKUMENT_UNDER_ARBEID_OPPRETTET, KLAGER, ROL_STATE, ROL_IDENT,
}
