...
enum class Felt {
    ...
    DOKDIST_REFERANSE, AVSLUTTET, VEDTAK_DISTRIBUERT, OVERSENDT_MEDUNDERSKRIVER, OPPLASTET_I_VEDTAK, INKLUDERTE_DATO_FOR_KLAGE,
    INKLUDERTE_DATO_FOR_VEDTAK, OVERSENDELSESBREV_BRA, KVALITETSAVVIK_OVERSENDELSESBREV, KVALITETSAVVIK_UTREDNING,
    KVALITETSAVVIK_VEDTAK, KOMMENTAR_OVERSENDELSESBREV, UTREDNING_BRA, KOMMENTAR_UTREDNING, VEDTAK_BRA, KOMMENTAR_VEDTAK,
    AVVIK_STOR_KONSEKVENS, BRUK_SOM_EKSEMPEL_I_OPPLAERING,
}
