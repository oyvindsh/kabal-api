...
enum class Felt {
    ...
    MEDUNDERSKRIVERFLYT, DOKUMENT_ENHET_ID_I_VEDTAK, SMART_EDITOR_ID, HOVEDADRESSAT_JOURNALPOST, DOKUMENT_UNDER_ARBEID_OPPLASTET, DOKUMENT_UNDER_ARBEID_TYPE, DOKUMENT_UNDER_ARBEID_ID
}
