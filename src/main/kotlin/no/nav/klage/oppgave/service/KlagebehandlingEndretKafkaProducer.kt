...
class KlagebehandlingEndretKafkaProducer(
    ...
    fun sendKlageEndret(klagebehandling: Klagebehandling) {
        ...
        runCatching {
            val result = aivenKafkaTemplate.send(
                ...
                esKlagebehandlingMapper.mapKlagebehandlingOgMottakToEsKlagebehandling(klagebehandling = klagebehandling)
                    .toJson()
            ).get()
    ...
    fun EsKlagebehandling.toJson(): String = objectMapper.writeValueAsString(this)
}
