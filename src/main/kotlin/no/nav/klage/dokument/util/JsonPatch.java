...
public class JsonPatch {
     ...
     * @return the patched JSON document
     */
    protected static JsonNode move(JsonNode doc, String path, String from) {
        // get the value
     ...
     * @return the patched JSON document
     */
    protected static JsonNode copy(JsonNode doc, String path, String from) {
        // get the value
        JsonNode value = doc.at(from);
        if (value.isMissingNode()) {
            throw new IllegalArgumentException("Invalid \"from\" property: " + from);
     ...
     * @return the patched JSON document
     */
    protected static JsonNode test(JsonNode doc, String path, JsonNode value) {
