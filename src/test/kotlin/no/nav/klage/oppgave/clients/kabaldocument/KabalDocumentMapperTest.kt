...
class KabalDocumentMapperTest {
    ...
    @Test
    fun `notat, skal Kun ha Saken Gjelder`() {
        ...
        val klagebehandling = Klagebehandling(
            ...
            sakenGjelder = SakenGjelder(PartId(PartIdType.PERSON, fnr)),
    ...
    fun `klager og sakenGjelder er ikke samme person, begge skal motta brev`() {
        ...
        val klagebehandling = Klagebehandling(
            ...
            kildeReferanse = "abc",
            klager = Klager(PartId(PartIdType.PERSON, fnr)),
            sakenGjelder = SakenGjelder(PartId(PartIdType.PERSON, fnr2)),
            mottakId = UUID.randomUUID(),
            mottattKlageinstans = LocalDateTime.now(),
            ytelse = Ytelse.OMS_OMP,
            type = Type.KLAGE,
    ...
    fun `klager, sakenGjelder og prosessfullmektige er ulike personer, alle skal motta kopi`() {
        ...
        val klagebehandling = Klagebehandling(
            ...
            sakenGjelder = SakenGjelder(PartId(PartIdType.PERSON, fnr3)),
            mottakId = UUID.randomUUID(),
            mottattKlageinstans = LocalDateTime.now(),
            ytelse = Ytelse.OMS_OMP,
            type = Type.KLAGE,
